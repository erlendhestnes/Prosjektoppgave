...
This chapter presents some necessary background knowledge about low-power design, accelerometers and microelectromechanical systems (MEMS).
...
Acceleration is defined as the rate of change in velocity with respect to time. It is given by a vector with both magnitude and direction relative to a reference frame. The SI units are length divided by time squared.
