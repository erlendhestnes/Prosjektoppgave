...
From Equation \ref{eq:p_dynamic} one can see that dynamic power consumption is proportional to the frequency. This means that a higher performance leads to a higher power consumption.
